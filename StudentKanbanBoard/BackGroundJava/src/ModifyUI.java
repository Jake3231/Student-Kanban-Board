public class ModifyUI {
    ...
    public void display(){
        ...
        System.out.println("Display Modify Page");
    ...
    public void changeUserName(String userName){
        ...
        if(this.userName.equals(userName)){
            System.out.println("The username entered is your current username please enter a different username.");
        }
    ...
    public void changeEmail(String email){
        ...
        if(this.email.equals(email)){
            System.out.println("The email address entered is your current email address. Please enter a different email address.");
        }
    ...
    public void changePassword(String newPassword){
        ...
        if(password.equals(newPassword)){
            System.out.println("The password entered is the same password as your current password. Please enter a different password.");
        }
