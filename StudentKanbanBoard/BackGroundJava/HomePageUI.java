...
public class HomePageUI {
    ...
    public void display(){
        ...
        System.err.println("display homePage");
        System.err.println("Homepage color: "+color);
        for(int i = 0; i < tickets.size(); i++){
            System.err.println("Ticket"+i+": Color: "+((Ticket) tickets.get(i)).getColor());
            System.err.println("Ticket"+i+": Title: "+((Ticket) tickets.get(i)).getTitle());
            System.err.print("Ticket"+i+": StartDate: "+((Ticket) tickets.get(i)).getStartYear()+":");
            ...
            System.err.print("Ticket"+i+": DueDate: "+((Ticket) tickets.get(i)).getEndYear()+":");
